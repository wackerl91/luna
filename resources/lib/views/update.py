...
class Update(pyxbmct.AddonDialogWindow):
    ...
    def set_info_controls(self, update):
        title_label = pyxbmct.Label(update.version, alignment=pyxbmct.ALIGN_LEFT, font='XLarge', textColor=COLOR_HEADING)
    ...
    def set_active_controls(self):
        ...
        self.connect(self.button_update, self.update)
        ...
        self.connect(self.button_cancel, self.close)
